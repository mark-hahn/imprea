...
(function() {
  ...
  if (typeof Object.assign !== "function") {
    Object.assign = function() {
      var args, i, len, nextKey, output, source, target;
      ...
      for (i = 0, len = args.length; i < len; i++) {
        ...
        if (source != null) {
          for (nextKey in source) {
            if (!hasProp.call(source, nextKey)) continue;
          ...
          return function(name) {
            ...
            return _this[name] = function(value) {
              ...
              if (!_.isEqual(globalObservableValues[name], value)) {
                globalObservableValues[name] = (typeof value === 'object' ? Object.assign({}, value) : value);
